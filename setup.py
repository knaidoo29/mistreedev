...
ext1 = Extension(name = 'mistreedev.utility_near_mst',
                 sources = ['mistreedev/utility_near_mst.f90'])

setup(name = 'mistreedev',
      version = '1.0.0',
      description       = "Development version of mistree additional functions.",
